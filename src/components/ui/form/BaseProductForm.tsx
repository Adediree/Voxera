...
import { BaseButtonProps } from "qucoon-components";
...
const BaseProductForm = <T, CreateRequest, UpdateRequest>({
  ...
  const finalInitialValues =
    initialValues || (isUpdate ? updateInitialValues : createInitialValues);
  ...
  return (
    <BaseCreateOrUpdateForm
      ...
      isUpdate={isUpdate}
      validationSchema={
        isUpdate ? updateValidationSchema : createValidationSchema
      }
