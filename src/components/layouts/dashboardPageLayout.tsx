"use client";
import TitleSubtitleCard, {
  TitleSubtitleCardProps,
} from "@/components/ui/card/TitleSubtitleCard";
import BreadCrumbs, {
  BreadCrumbsProps,
...
export type DashboardPageLayoutProps = {
  ...
  mainContentProps?: {
    containerProps?: React.DetailedHTMLProps<
      ...
      HTMLElement
    >;
    contentHeaderContainerProps?: React.DetailedHTMLProps<
...
const DashboardPageLayout = ({
  ...
  return (
    ...
    >
      <main
        {...mainContentProps?.containerProps}
      ...
      >
        ...
        {(mainContentProps?.contentHeaderContainerProps || true) && (
          <div
            {...mainContentProps?.contentHeaderContainerProps}
            style={{
              display: "flex",
              alignItems: "center",
              width: "100%",
          ...
          >
            <TitleSubtitleCard
              ...
              title={
                Object.values(RouteConstant.dashboard).find(
