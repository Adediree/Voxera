...
export type ConfirmationModalVariants =
  | "warning"
  | "error"
  | "success"
  | "default";
...
const ConfirmationModalLayout = ({
  ...
  const iconWrapperVariants: Record<
    ConfirmationModalVariants,
    Pick<
      IconWrapperProps,
      "backgroundColor" | "iconColor" | "outlineColor" | "icon"
    >
  > = {
    success: {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <Typography size={"lg"} className={styles.title}>
          {title}
        </Typography>
        {subtitle && (
        ...
        <BaseButton
          ...
          style={{
            backgroundColor:
              variant == "error"
                ? "#d92d20"
                : endBtnProps?.style?.backgroundColor,
            ...endBtnProps?.style,
          }}
          onClick={(e) => {
